...
Côté **confidentialité**, ta prise est **privée par défaut**. Tu peux la rendre visible à tes amis (coords précises) ou à la communauté (coords floutées de plusieurs centaines de mètres pour protéger ta plage contre le spot-burning).
