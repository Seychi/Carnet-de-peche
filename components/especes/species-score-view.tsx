...
// Présentation PURE du score par espèce (sprint 23, WS-B — extraite au sprint 84).
//
// Aucun accès aux données ici : le markup est strictement celui d'avant, seulement
// séparé de la lecture. C'est ce qui permet au SERVEUR de rendre la variante anonyme
// (mise en cache, servie à Googlebot) et au CLIENT de re-rendre la variante du
// visiteur connecté après hydratation, avec exactement le même composant. Un seul
// gabarit, donc aucune divergence visuelle possible entre les deux états.
//
...
export function SpeciesScoreView({
  s,
  article,
  labelLower,
}: {
