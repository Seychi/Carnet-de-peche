...
/**
 * Liste « ma boîte ». Vide propre + CTA si aucun matériel. Sinon une carte par
 * item, triée (le plus pêchant d'abord) côté serveur.
 */
export function GearBoxList({ entries }: { entries: GearBoxEntry[] }) {
  if (entries.length === 0) {
    return (
