...
export async function NextWindowInsight({ dept }: { dept: string }) {
  ...
  return (
    <div className="mb-6 flex flex-col gap-3">
      <div className="flex items-center gap-4 rounded-[14px] border border-sand-200 bg-white p-4 shadow-[inset_3px_0_0_var(--teal-500)] sm:gap-5 sm:p-5">
      ...
      <ScoreBreakdown window={window} title="De quoi est fait ce créneau" />
    </div>
  )
}
