...
export const metadata: Metadata = {
  title: 'Espèces — Bientôt disponible · Carnet de Pêche',
  description:
    'Bar, dorade royale, lieu jaune, maquereau, sar, orphie : les fiches espèces pour la pêche à la canne du bord arrivent bientôt. Inscris-toi pour être notifié.',
}
  ...
  return (
    <main className="bg-sand-50 min-h-screen py-20">
      <div className="max-w-[680px] mx-auto px-6 text-center">
        ...
        <h1 className="font-display text-4xl text-navy-900 mb-4">Toutes les espèces</h1>
        <p className="text-lg text-ink-700 leading-relaxed mb-8">
          Bientôt : des fiches détaillées pour le bar, la dorade royale, le lieu jaune,
          le maquereau, le sar et l&apos;orphie — saisons, conditions, techniques et spots
