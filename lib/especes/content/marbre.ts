...
export const marbreEspece: EspeceContent = {
  ...
  postes: [
    ...
    `En Méditerranée, le marnage est négligeable : ce n'est pas la marée qui commande mais la lumière, le vent et l'état du sable. Pêche le crépuscule et la nuit, amorce léger autour de tes lignes pour fixer le poste, et surveille ta bannière de près — la touche du marbré est souvent une simple détente ou un petit tapotement, pas un départ franc. Logue tes prises avec le poste exact, l'heure et l'état de la mer : sur une même plage, les cuvettes productives reviennent et tes patterns t'y ramèneront plus vite.`,
  ],
